...
public class ObjectFactory {
    ...
    private final static QName _ShowMarketFault_QNAME = new QName("http://topdown.soacourse.unsw.edu.au", "showMarketFault");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.soacourse.unsw.edu.au", name = "showMarketFault")
    public JAXBElement<ServiceFaultType> createShowMarketFault(ServiceFaultType value) {
        return new JAXBElement<ServiceFaultType>(_ShowMarketFault_QNAME, ServiceFaultType.class, null, value);
    }
